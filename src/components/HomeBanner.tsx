...
export default function HomeBanner() {
    ...
    return (
        <div className="relative lg:h-[80vh] md:h-[45vh] h-[50vh] bg-gray-50">
            {/* Hero Content */}
            <div className="relative z-10">
                ...
                <div className="absolute top-[145%] lg:top-[115%] md:top-[120%] inset-0 flex justify-center items-center">
                    <img
