    ...
    return (
        <div className="relative lg:h-[80vh] md:h-[55vh] h-[65vh] bg-gray-50">
            ...
            <div className="relative z-10">
                ...
                <div className="absolute md:h-32 lg:h-32 md:w-28 lg:w-28 h-20 w-14 -rotate-12 top-[130%] left-[77%] md:top-[120%] lg:top-[95%] md:left-[65%] lg:left-[58%]">
                    <img src="/assets/arrow.png" alt="" />
                </div>
                <div className="absolute font-serif top-[177%] left-[85%] md:top-[166%] lg:top-[142%] md:left-[76%] lg:left-[64%]">
                    <motion.div
                        initial={{ y: 0 }}
